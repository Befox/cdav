...
class Dolibarr extends AbstractBackend implements SyncSupport {
    ...
    function __construct($user, $db, $langs) {
        ...
        $langs->trans("ThirdPartyProspects")
        
        $alladdressbooks = array(
            'propects' => $langs->trans("ThirdPartyProspects"),
            'customers' => $langs->trans("ThirdPartyCustomers"),
            'suppliers' => $langs->trans("ThirdPartySuppliers"),
            'others' => $langs->trans("OthersNotLinkedToThirdParty") );
    }
